...
# ============================== SUMMARY =====================================
#
# Program : check_naglio_aeropsike_latency.pl
...
#
#  ./check_naglio_aeropsike_latency.pl -o 'PATTERN:TCP_mem_usage_percent,WARN:>70,CRIT:>85' -o 'PATTERN:TCP_orphans_usage_percent,WARN:>20,CRIT:>30' 
#
...
my $nlib = Naglio->lib_init('plugin_name' => 'check_naglio_aeropsike_latency.pl',
...
check_options($nlib);
$nlib->verb("check_naglio_aeropsike_latency.pl plugin version ".$Version);
